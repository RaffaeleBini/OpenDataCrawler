...
- **18 datasets reales conectados** desde 11 fuentes distintas — 5 de España/Galicia (abertos.xunta.gal, datos.gob.es, IGE, INE, opendata.esri.es) y 6 internacionales (data.gov.uk en Reino Unido, catálogo de la FAO y la OMS a nivel mundial, GovData en Alemania, data.gov.ie en Irlanda, data.gouv.fr en Francia) — usando 6 mecanismos de recolección (DCAT/RDF, DCAT JSON, y cuatro conectores a medida), cubriendo las cuatro cadenas de valor (detalle, avisos de calidad de datos y decisiones técnicas en docs/fuentes.md).
